...
# 修改商品id 即可下载评论与图片
    ...
    while True:
        ...
        for i in rateCellList:
            ...
            f = open("/Users/fengtingting/Downloads/python/{}/{}/{}.txt".format(filename, contentfile, nick), 'a')
            f.write(content)
            f.close()
            ...
            if not pic:
                ...
                for p in pic:
                    ...
                    m.update(picture)
                    md5_url = m.hexdigest()
                    with open("/Users/fengtingting/Downloads/python/{}/{}/{}.jpg".format(filename,contentfile, md5_url ), 'wb') as u:
                        u.write(pict.content)


                    # with open("/Users/fengtingting/Downloads/python/{}/{}/{}/{}.jpg".format(filename, contentfile, content, md5_url ), 'wb') as u:
                    #     u.write(pict.content)
                    #
        if list == total:
            print(total)
